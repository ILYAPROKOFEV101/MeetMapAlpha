...
dependencies {
    ...
    implementation ("androidx.lifecycle:lifecycle-runtime-compose-android:2.9.0-alpha11")
    implementation ("androidx.lifecycle:lifecycle-viewmodel-compose-android:2.9.0-alpha11")
